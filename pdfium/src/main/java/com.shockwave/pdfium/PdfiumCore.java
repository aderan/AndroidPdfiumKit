...
public class PdfiumCore {
    ...
    private native void nativeTextClosePage(long textPagePtr);

    private native int nativeTextCountChars(long textPagePtr);

    private native int nativeTextGetText(long textPagePtr, int start_index, int count, char[] chars);

    private native int nativeTextGetBoundedText(
        long textPagePtr,
        double left,
        double top,
        double right,
    ...
    private native RectF nativeTextGetRect(long textPagePtr, int rect_index);
    ...
    /**
     * Get page width in pixels. <br> This method requires page to be opened.
     */
    ...
    /**
     * Get page height in pixels. <br> This method requires page to be opened.
     */
    ...
    /**
     * Get page width in PostScript points (1/72th of an inch).<br> This method requires page to be opened.
     */
    ...
    /**
     * Get page height in PostScript points (1/72th of an inch).<br> This method requires page to be opened.
     */
    ...
    /**
     * Get size of page in pixels.<br> This method does not require given page to be opened.
     */
    ...
    /**
     * Render page fragment on {@link Surface}.<br> Page must be opened before rendering.
     */
    public void renderPage(
        PdfDocument doc, Surface surface, int pageIndex,
        int startX, int startY, int drawSizeX, int drawSizeY) {
        renderPage(doc, surface, pageIndex, startX, startY, drawSizeX, drawSizeY, false);
    }

    /**
     * Render page fragment on {@link Surface}. This method allows to render annotations.<br> Page must be opened before
     * rendering.
     */
    public void renderPage(
        PdfDocument doc, Surface surface, int pageIndex,
    ...
    /**
     * Render page fragment on {@link Bitmap}.<br> Page must be opened before rendering.
     * <p>
    ...
    public void renderPageBitmap(
        PdfDocument doc, Bitmap bitmap, int pageIndex,
        int startX, int startY, int drawSizeX, int drawSizeY) {
        renderPageBitmap(doc, bitmap, pageIndex, startX, startY, drawSizeX, drawSizeY, false);
    }

    /**
     * Render page fragment on {@link Bitmap}. This method allows to render annotations.<br> Page must be opened before
     * rendering.
     * <p>
     ...
     * @param rotate    page orientation: 0 (normal), 1 (rotated 90 degrees clockwise), 2 (rotated 180 degrees), 3
